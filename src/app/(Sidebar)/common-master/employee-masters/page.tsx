...
// import { CompanyDetails, EmployeeMaster } from "@/config/common-master-forms";
...
// const PAGENAME: string = "Employee Masters";
...
//   const form = useForm<TemployeeMasterValidator>({
//     resolver: zodResolver(employeeMasterValidator),
//     defaultValues: {
//       FatherHusbandName: "",
//       DateOfBirth: "",
//       EmployeeFirstName: "",
...
//   const onSubmit: SubmitHandler<TemployeeMasterValidator> = async (values) => {
//     try {
//     } catch (error) {}
//   };
...
//               </DialogHeader>
//               <FormModule<TemployeeMasterValidator>
//                 form={form}
//                 //@ts-ignore
//                 onSubmit={onSubmit}
//                 date={date}
...
//         <TableModule tableName={PAGENAME} header={EmployeeMasterHeaders} />
//       </div>
//     </MaxWidthWrapper>
//   );
// }
