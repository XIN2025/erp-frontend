...
//   return (
//     <Form {...form}>
//       <ScrollArea className="h-[calc(95vh-4rem)] overflow-y-auto">
...
//             );
//           })}
//           {data && <GSTTable data={data} setData={setData} />}
...
const calculateScrollAreaHeight = (fieldCount: number) => {
  const baseHeight = 200; // minimum height in pixels
  const heightPerField = 70; // estimated height per field in pixels
  const maxHeight = window.innerHeight * 0.8; // maximum height (80% of viewport height)
